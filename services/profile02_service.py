...
def generate_nickname(prompt, job):
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "'미안해' 표현을 닉네임에 그대로 반복하지 말고, 감정을 간접적으로 표현해줘. examples: '갈등을 피하고 싶어하는 스타일의', '상대방에게 져주는 성격인', '배려가 몸에 밴', '불화보단 평화를 택하는 연애 스타일의' 같은 식으로, 단어 선택은 부드럽고 위트있게"},
            {"role": "system", "content": "성적인 내용, 폭력적인 표현, 욕설, 차별적인 발언, 특정 대상 비하, 음란한 뉘앙스는 절대 포함하지 마. '성전환'도 절대 들어가면 안돼"},
            {"role": "system", "content": "형용사 기반 수식어구를 만들어줘. 전체는 20자 이내로 오직 하나만. examples: '지고지순 순정파인', '갈등은 피하는 타입의', '곱게 자란 외동딸인', '아내의 집밥을 먹고 싶은'"},
